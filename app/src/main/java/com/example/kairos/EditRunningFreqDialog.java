...
public class EditRunningFreqDialog extends Dialog {
    ...
    public EditRunningFreqDialog(Context ctx, List<Boolean> freq, OnSaveListener listener) {
        super(ctx);
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_edit_running_freq);
        ...
        ImageButton save = findViewById(R.id.btnSaveRunning);
